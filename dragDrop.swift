    ...
    var body: some View {
        HStack(spacing: 20) {
            ...
            if recycling.contains("CDs 💿") {
                ...
                Text("You got it! Due to their materials, CDs are recyclable, but due to their mixed-plastic composition, it is best to recycle them in places like local library drop-off stations, schools, or thrift-stores.")
            }
            
            if recycling.contains("Batteries 🔋") {
                Text("Almost there! Most types of batteries are recyclabe, but the recycling of them should take place in special drop-off locations or special recycling programs due to their flammability if exposed to heat.")
                ...
                Text("Yes! Due to their flammability, batteries should be recycled in special drop-off locations or special recycling programs due to their flammability if exposed to heat. WHOAH! A lot of these are Depends! Recyclng is a tricky process that has a lot of rules and steps, so it's always good to know what to do with daily-use materials in order to save our planet!")
            }
            ...
            if recycling.contains("Boxes📦") {
                    ...
                    Text("This is a bit simpler. If anything could be normally recycled, it's cardboard boxes! Give this one another try!")
                }
